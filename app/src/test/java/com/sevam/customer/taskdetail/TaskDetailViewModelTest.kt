...
package com.sevam.customer.taskdetail

import androidx.lifecycle.SavedStateHandle
import com.sevam.customer.MainCoroutineRule
import com.sevam.customer.R
import com.sevam.customer.SevamDestinationsArgs
import com.sevam.customer.data.FakeTaskRepository
...
class TaskDetailViewModelTest {
    ...
    fun setupViewModel() {
        ...
        taskDetailViewModel = TaskDetailViewModel(
            tasksRepository,
            SavedStateHandle(mapOf(SevamDestinationsArgs.TASK_ID_ARG to "0"))
        )
    }
    ...
    fun taskDetailViewModel_taskNotFound() = runTest {
        ...
        taskDetailViewModel = TaskDetailViewModel(
            tasksRepository,
            SavedStateHandle(mapOf(SevamDestinationsArgs.TASK_ID_ARG to "nonexistent_id"))
        )
