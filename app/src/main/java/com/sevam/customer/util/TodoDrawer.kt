...
import com.sevam.customer.SevamDestinations
import com.sevam.customer.SevamNavigationActions
...
fun AppModalDrawer(
    ...
    currentRoute: String,
    navigationActions: SevamNavigationActions,
    ...
    Surface(color = MaterialTheme.colorScheme.background) {
        Column(modifier = modifier.fillMaxSize()) {
            ...
            DrawerButton(
                ...
                isSelected = currentRoute == SevamDestinations.TASKS_ROUTE,
                action = {
                    navigateToTasks()
                    closeDrawer()
                }
            ...
            DrawerButton(
                ...
                isSelected = currentRoute == SevamDestinations.STATISTICS_ROUTE,
                action = {
...
fun PreviewAppDrawer() {
    SevamTheme {
        Surface {
            AppDrawer(
                currentRoute = SevamDestinations.TASKS_ROUTE,
                navigateToTasks = {},
                navigateToStatistics = {},
                closeDrawer = {}
            )
