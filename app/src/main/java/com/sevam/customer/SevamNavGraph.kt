...
import com.sevam.customer.addedittask.AddEditTaskScreen
import com.sevam.customer.statistics.StatisticsScreen
...
fun SevamNavGraph(
    ...
    NavHost(
        ...
        composable(SevamDestinations.STATISTICS_ROUTE) {
            AppModalDrawer(drawerState, currentRoute, navActions) {
                StatisticsScreen(openDrawer = { coroutineScope.launch { drawerState.open() } })
            }
        }
        composable(
            SevamDestinations.ADD_EDIT_TASK_ROUTE,
            arguments = listOf(
        ...
        composable(SevamDestinations.TASK_DETAIL_ROUTE) {
            TaskDetailScreen(
                onEditTask = { taskId ->
